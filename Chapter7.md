...
相信积累的力量，本质上就是相信复利的力量。不要以为“一年365天，每天进步一点点”，最终的收获就是365点，这是莎士比亚的算法——他认为应该用简单加法。而实际上，如若真的每天进步一点点，一年下来，收获最终很可能是`P(1+i)^n`，其值取决于每天进步的量（i）和起步时的实力（P），这是夏洛克的算法——指数级增长。
